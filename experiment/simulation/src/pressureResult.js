...
if("calculation" in data){
	...
	wrong  = data.calculation.calculation;
	correct = 6;
}	
	

if ("constLib" in data){
	corrapp = data.constLib.invalidCnt;
	
}

if ("whtStone" in data){
	whtcorr = data.whtStone.correct;
	whtwor = data.whtStone.wrong;
	
}	

if ("graph" in data){
	error = data.graph.err;
	sensitivity = data.graph.sens;
...
var charac = ( 2/(error+sensitivity))*100;
	
 var calculation = (correct/wrong)*100;
	
	 console.log("eddy__"+calculation);
	

var oberve = (whtcorr/whtwor)*100;	
 
 var constrct = (1/corrapp)*100;
    ...
    +'<div class="container-fluid">'
		...
		+'<div class="col-md-4">'
		 ...
		 +'<br><table class="table table-bordered ">'
		   ...
		   +'    <tr class="">'
		   +'      <th><center class="">COMPETENCY(PRESSURE SENSOR)</center></th>'
		  ...
		  htm +='  </tr>'
		   ...
		   +'   <tr>'
		  +'     <td class=""><center>Voltage Calculation</center></td>'
		  if(oberve>=60){ 
...
//        
		...
		+' <div class="panel panel-danger headingPanel" >'
		+' <div class="panel-body" id="panelbody">'
		+'<center><span class="heading1"><b> Calculation</b></span></center>'
		+'</div>'
		+'</div>'
...
//
		...
		+'<center><span class="valueBox"><b>'+sensitivity+'  </b></span></center>'
		+'</div>'
		+'</div>'
		...
		+'<div class="col-sm-4">'
		+' <div class="panel panel-danger headingPanel" >'
		+' <div class="panel-body" id="panelbody"><center><span class="heading1"><b> Error Calculation </b></span></center></div>'
		+'</div>'
		...
		+'<center><span class="valueBox"><b>'+error+' </b></span></center>'
		+'</div>'
		+'</div>'
		+'</div>'
		...
		+' <div class="panel panel-danger headingPanel" >'
		+' <div class="panel-body" id="panelbody">'
		+'<center><span class="heading1"><b>Voltage Calculate</b></span></center>'
		+'</div>'
		+'</div>'
		...
		+'<center><span class="valueBox"><b> '+whtwor+' </b></span></cent>'
		+'</div>'
		+'</div>'
//		+'<span class="heading1">4 </span>'
		+'</div>'
		...
		+'<center><span class="valueBox"><b>'+whtcorr+'</b></span></center>'
		+'</div>'
		+'</div>'
//		+'<span class="heading1">1 </span>'
		+'</div>'
...
let initialData = [
    ...
    { name: 'Configuration', y: calculation },
    { name: 'Configuration', y: charac },
     { name: 'Configuration', y: constrct }
...
$("#pdfDownload").prop("hidden",false);
    ...
    html2canvas(element, {
        ...
        pdf.save("Pressure_Sensor_Report.pdf");
    });
}
