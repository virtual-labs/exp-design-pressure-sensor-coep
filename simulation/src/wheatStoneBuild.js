...
$("#centerText1").html('SELECT THE COMPONENTS');
$("#centerText").html('CONNECT THE PORTS OF WHEATSTONE BRIDGE');
$("#tableDesign").html("");
...
//            return; // Exit the function here
		...
		htm = '<div class="row" id="timeAnswer">'
				     +'<div class="col-sm-6">'
				       ...
				       +'</div>'
				       +'<div class="col-sm-3">'
				       +'<br><button type="submit" id="btnAnsCheck" style="margin-top:17px; width:100%;" class=" btn btn-danger" data-toggle="modal" data-target="#myModal" >Submit</button>'
...
//				 $("#calculatePressure").html(Calculate);	 
    		  ...
    		  $("#canvas-div").html(labels2);
    		   ...
    		   $("#centerText1").html('PRESSURE SENSOR');
			    mimic2();
...
//            return; // Exit the function here  
		...
		htm = '<div class="row" id="timeAnswer">'
				     +'<div class="col-sm-6">'
				       ...
				       +'</div>'
				       +'<div class="col-sm-3">'
				       +'<br><button type="submit" id="btnAnsCheck" style="margin-top:17px; width:100%;" class=" btn btn-danger" data-toggle="modal" data-target="#myModel" >Submit</button>'
//				       + '<button type="button"  class="btn btn-primary btnStyle" id="next" hidden >Next Level</button>'
				       +'</div>'
