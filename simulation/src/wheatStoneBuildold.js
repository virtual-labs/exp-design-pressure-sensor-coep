...
const myDiv1 = document.getElementById('main-div-conf'); // Or use querySelector if needed
    ...
    myDiv1.style.height = '1000px'; // Set the height    
...
$("#main-div-conf").html("");
		...
		htm = '<div class="row" id="timeAnswer">'
				     +'<div class="col-sm-6">'
				       ...
				       +'</div>'
				       +'<div class="col-sm-3">'
				       +'<br><button type="submit" id="btnAnsCheck" style="margin-top:17px; width:100%;" class=" btn btn-danger" data-toggle="MsgModal" data-target="#selectCheck" >Submit</button>'
