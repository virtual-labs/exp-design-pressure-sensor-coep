function mimic2() {
	...
	if (step == 1) {
		console.log("y"+y_ans);
		tor_sen = paper.text(x + 250, y + 20, "Calculate radial stress  at r = "+ri+"mm and submit the answer")
			.attr({
				'font-size': 20,
				'fill': 'red'
	...
	function step2(x, y) {
		...
		var step2 = paper.text(x + 250, y + 60, "Calculate tangential stress  at r = "+ri+"mm and submit the answer")
			.attr({
				'font-size': 20,
				'fill': 'red'
		...
		var step2 = paper.text(x + 250, y + 60, "Calculate tangential stress  at r = "+ri+"mm and submit the answer")
			...
			var step3 = paper.text(x + 250, y + 90, "Calculate radial stress  at r = "+rt+"mm and submit the answer")
			.attr({
				'font-size': 20,
				'fill': 'red'
		...
		function step4(x,y){
			...
			var step4 = paper.text(x + 250, y + 120, "Calculate tangential stress  at r = "+rt+"mm and submit the answer")
			.attr({
				'font-size': 20,
				'fill': 'red'
		...
		function step5(x,y){
			...
			var step5 = paper.text(x + 250, y + 150, "Calculate Er  at r = "+ri+"mm and submit the answer")
			.attr({
				'font-size': 20,
				'fill': 'red'
		...
		function step6(x,y){
			...
			var step6 = paper.text(x + 250, y + 180, "Calculate Et  at r = "+rt+"mm and submit the answer")
			.attr({
				'font-size': 20,
				'fill': 'red'
